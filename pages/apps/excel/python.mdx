...
`BOARDFLARE.RUNPY` is a legacy function that can still be used, but is not recommended for most use-cases.  The code editor and automatically generated LAMBDA functions are the preferred way to work with Python code in Excel.
...
<details>
  <summary>1.1.0 - 2025-01-17</summary>
