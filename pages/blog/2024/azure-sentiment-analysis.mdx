...
The workbook which implements this is available here: [Azure Sentiment Analysis in Excel](https://whistlernetworks.sharepoint.com/:x:/s/Boardflare/EfVwGShk-o5Bq3j47GYdc6oBIZfk0lTXNHvDbQCjqVD9FA?e=lOceuX) which also has a link to the source code.
